...
;; This is a major mode for editing ShExC documents, originally created as
;; N3-mode by Hugo Haas and Dave Pawson, then adapted by Eric Prud'hommeaux
;; and Vladimir Alexiev.
;;
;; A newer, tree-sitter-based companion mode, `shexc-ts-mode' (see
;; shexc-ts-mode.el), adds structure-aware indentation, navigation, `xref',
;; `flymake' diagnostics, live highlighting, and more, for Emacs 29+.
...
;; (add-hook 'shexc-mode-hook 'turn-on-font-lock)
;;
...
;;        auto-mode-alist))
;;
;; If you want it to load a little faster:
;; C-x f shexc-mode.el
;; M-x byte-compile-file shexc-mode.el
;;
;; You can also use `imenu' to make an index of shapes, and `imenu-list'
;; (https://github.com/bmag/imenu-list) to see them in a panel on the right:
;;
...
;;
;; See the project README for a screenshot of this panel showing the shape
;; index for fhir.shex (http://hl7.org/fhir/fhir.shex).
